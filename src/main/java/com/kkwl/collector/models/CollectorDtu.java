  ...
  public class CollectorDtu
  {
    ...
    public byte getShouldReportConnectionAlarm() { return this.shouldReportConnectionAlarm; }
  
  
  
    
    public void setShouldReportConnectionAlarm(byte shouldReportConnectionAlarm) { this.shouldReportConnectionAlarm = shouldReportConnectionAlarm; }
