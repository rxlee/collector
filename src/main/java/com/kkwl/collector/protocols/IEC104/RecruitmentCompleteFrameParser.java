  ...
  {
    public RecruitmentCompleteFrameParser() { super(FrameType.IEC104_RECRUITMENT_COMPLETE_FRAME.value()); }
    ...
    public Map<String, Object> parseBytesFrame(byte[] frameBytes, Map<String, Object> params) {
      ...
      if (frameLen > 8 && frameBytes[6] == 100 && frameBytes[8] == 10) {
        ...
        retMap.put("type", FrameType.IEC104_RECRUITMENT_COMPLETE_FRAME);
      } else {
...
/* Location:              C:\Users\Andy\Desktop\EMS\server-2\kk\collector\collector-0.0.1-SNAPSHOT.jar!\BOOT-INF\classes\com\kkwl\collector\protocols\IEC104\RecruitmentCompleteFrameParser.class
