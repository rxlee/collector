  ...
  {
    public RecruitmentACKFrameParser() { super(FrameType.IEC104_RECRUITMENT_ACK_FRAME.value()); }
    ...
    public Map<String, Object> parseBytesFrame(byte[] frameBytes, Map<String, Object> params) {
      ...
      if (frameLen > 8 && frameBytes[6] == 100 && frameBytes[8] == 7) {
        ...
        retMap.put("type", FrameType.IEC104_RECRUITMENT_ACK_FRAME);
      } else {
...
/* Location:              C:\Users\Andy\Desktop\EMS\server-2\kk\collector\collector-0.0.1-SNAPSHOT.jar!\BOOT-INF\classes\com\kkwl\collector\protocols\IEC104\RecruitmentACKFrameParser.class
