  ...
  public class HistoryYCParser extends BaseFrameParser
  {
    public HistoryYCParser() { super(FrameType.IEC104_HISTORY_YC_FRAME.value()); }
    ...
    public Map<String, Object> parseBytesFrame(byte[] frameBytes, Map<String, Object> params) {
      ...
      if (frameLen > 7 && frameBytes[6] == -10) {
        ...
        retMap.put("type", FrameType.IEC104_HISTORY_YC_FRAME);
      } else {
        retMap.put("result", Boolean.valueOf(false));
      } 
...
/* Location:              C:\Users\Andy\Desktop\EMS\server-2\kk\collector\collector-0.0.1-SNAPSHOT.jar!\BOOT-INF\classes\com\kkwl\collector\protocols\IEC104\HistoryYCParser.class
