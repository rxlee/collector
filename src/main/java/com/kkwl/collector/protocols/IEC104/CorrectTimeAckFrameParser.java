  ...
  public class CorrectTimeAckFrameParser extends BaseFrameParser
  {
    public CorrectTimeAckFrameParser() { super(FrameType.IEC104_CORRECT_TIME_ACK_FRAME.value()); }
    ...
    public Map<String, Object> parseBytesFrame(byte[] frameBytes, Map<String, Object> params) {
      ...
      if (frameBytes[6] == 103) {
        ...
        retMap.put("type", FrameType.IEC104_CORRECT_TIME_ACK_FRAME);
      } else {
...
/* Location:              C:\Users\Andy\Desktop\EMS\server-2\kk\collector\collector-0.0.1-SNAPSHOT.jar!\BOOT-INF\classes\com\kkwl\collector\protocols\IEC104\CorrectTimeAckFrameParser.class
