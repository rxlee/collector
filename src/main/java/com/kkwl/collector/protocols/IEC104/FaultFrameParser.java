  ...
  public class FaultFrameParser extends BaseFrameParser
  {
    public FaultFrameParser() { super(FrameType.IEC104_FAULT_I_FRAME.value()); }
    ...
    public Map<String, Object> parseBytesFrame(byte[] frameBytes, Map<String, Object> params) {
      ...
      if (frameLen > 6 && frameBytes[6] == 42) {
        ...
        retMap.put("type", FrameType.IEC104_FAULT_I_FRAME);
...
/* Location:              C:\Users\Andy\Desktop\EMS\server-2\kk\collector\collector-0.0.1-SNAPSHOT.jar!\BOOT-INF\classes\com\kkwl\collector\protocols\IEC104\FaultFrameParser.class
