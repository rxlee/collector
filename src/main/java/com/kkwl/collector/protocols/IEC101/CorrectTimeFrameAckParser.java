  ...
  public class CorrectTimeFrameAckParser
    extends BaseFrameParser
  {
    public CorrectTimeFrameAckParser() { super(FrameType.IEC101_CORRECT_TIME_ACK_FRAME.value()); }
    ...
    public Map<String, Object> parseBytesFrame(byte[] frameBytes, Map<String, Object> params) {
      ...
      if (frameBytes[1] == 18 && frameBytes[7] == 103 && frameBytes[9] == 7) {
        ...
        if (paramAddress == address) {
          retMap.put("type", FrameType.IEC101_CORRECT_TIME_ACK_FRAME);
...
/* Location:              C:\Users\Andy\Desktop\EMS\server-2\kk\collector\collector-0.0.1-SNAPSHOT.jar!\BOOT-INF\classes\com\kkwl\collector\protocols\IEC101\CorrectTimeFrameAckParser.class
